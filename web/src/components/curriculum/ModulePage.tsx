...
const STEP_META: Record<StepType, StepMeta> = {
  ...
  concepts:  { icon: Lightbulb,    label: 'Key Ideas',       bg: 'bg-sky-50 dark:bg-sky-950/40',               border: 'border-sky-200 dark:border-sky-800',      topBar: '#0ea5e9', pillBg: 'bg-sky-100 dark:bg-sky-900/50',         pillText: 'text-sky-700 dark:text-sky-300',      headingColor: 'text-sky-900 dark:text-sky-100',    dark: false },
  facts:     { icon: Sparkles,     label: 'Fun Facts',       bg: 'bg-amber-50 dark:bg-amber-950/40',           border: 'border-amber-200 dark:border-amber-800',  topBar: '#f59e0b', pillBg: 'bg-amber-100 dark:bg-amber-900/50',     pillText: 'text-amber-800 dark:text-amber-300',  headingColor: 'text-amber-900 dark:text-amber-100',dark: false },
  reflect:   { icon: Brain,        label: 'Think About It',  bg: 'bg-violet-50 dark:bg-violet-950/40',         border: 'border-violet-200 dark:border-violet-800',topBar: '#8b5cf6', pillBg: 'bg-violet-100 dark:bg-violet-900/50',   pillText: 'text-violet-700 dark:text-violet-300',headingColor: 'text-violet-900 dark:text-violet-100',dark: false },
